...
from utils import DB_PATH, log, normalize_text, ollama_generate
...
# Alias dictionaries for intent detection and strategy matching

STRATEGY_ALIASES = {
    "core fixed income": [
        "core fixed income", "core bond", "core bonds", "aggregate", "agg",
        "us aggregate", "bloomberg us aggregate",
    ],
    "global fixed income": [
        "global fixed income", "global bond", "global bonds", "global aggregate",
    ],
    "inflation-linked": [
        "inflation-linked", "inflation linked", "tips", "linkers", "inflation bonds",
    ],
    "short duration": [
        "short duration", "short-term bond", "short term bond", "1-3 year", "ultra short",
    ],
    "emerging market debt": [
        "emerging market debt", "em debt", "emd", "emerging debt", "embi", "sovereign debt",
    ],
    "high yield": [
        "high yield", "junk bond", "junk bonds", "below investment grade", "credit spreads",
    ],
}
...
# Route-specific SQL query builders
...
# Route selection and answer merging
