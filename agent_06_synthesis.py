...
MAX_SECTION_CONTEXT_CHARS = CONFIG["MAX_SECTION_CONTEXT_CHARS"]
MAX_INSIGHT_CONTEXT_CHARS = CONFIG["MAX_INSIGHT_CONTEXT_CHARS"]
...
def convert_to_pdf(html_path: str, pdf_path: str) -> bool:
    """Convert HTML to PDF using Playwright's Chromium renderer."""
    try:
